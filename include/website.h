...
<!DOCTYPE HTML><html><head>
  ...
  <form action="/get">
    ...
    <table>
      ...
      <tr>
        <td>Symbole </td>
        <td><input type="checkbox" name="christmaSymbolsCheckbox" value="checked" %ENABLE_CHRISTMASSYMBOLS_INPUT% onClick="this.form.submit();"></td>
        <td><input name="preTimeChristmasSymbols" type="number" min="0" max="300" value="%PRETIMECHRISTMASSYMBOLSOPTIONS%"></td>
        <td><input name="christmaSymbolsDelay" type="number" min="5" max="1000" value=%CHRISTMASSYMBOLSDELAYOPTIONS%></td>
        <td><input name="christmaSymbolsDuration" type="number" min="0" max="300" value="%CHRISTMASSYMBOLSDURATIONOPTIONS%"></td>
      </tr>
      <tr>
        <td>Sternenhimmel </td>
