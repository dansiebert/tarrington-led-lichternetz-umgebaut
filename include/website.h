  ...
  <form action="/get">
    ...
    <table>
      ...
      <tr>
        ...
        <td><input type="checkbox" name="pixelFallCheckbox" value="checked" %ENABLE_PIXELFALL_INPUT% onClick="this.form.submit();"></td>
        <td><input name="pixelFallPreTime" type="number" min="0" max="300" value="%PIXELFALLPRETIMEOPTIONS%"></td>
        <td><input name="pixelFallDelay" type="number" min="5" max="1000" value=%PIXELFALLDELAYOPTIONS%></td>
        <td><input name="pixelFallDuration" type="number" min="0" max="300" value="%PIXELFALLDURATIONOPTIONS%"></td>
      </tr>
      <tr>
    ...
    <tr><td>City-ID</td><td><input name="cityID" type="text" size="7" value="%CITYIDOPTIONS%">&nbsp;%WEATHERLOCATION%</td></tr>
    <tr><td>Anzahl Sterne</td><td><input name="starCount" type="number" min="1" max="1000" value=%STARCOUNTOPTIONS%></td></tr>
    <tr><td>Datum</td><td><input type="checkbox" name="dateCheckbox" value="checked" %ENABLE_DATE_INPUT% onClick="this.form.submit();"></td></tr>
    <tr><td>Temperatur</td><td><input type="checkbox" name="tempCheckbox" value="checked" %ENABLE_TEMP_INPUT% onClick="this.form.submit();"></td></tr>
    <tr><td>Regen</td><td><input type="checkbox" name="rainCheckbox" value="checked" %ENABLE_RAIN_INPUT% onClick="this.form.submit();"></td></tr>
    <tr><td>Wind</td><td><input type="checkbox" name="windCheckbox" value="checked" %ENABLE_WIND_INPUT% onClick="this.form.submit();"></td></tr>
    <tr><td>Luftfeuchte</td><td><input type="checkbox" name="humidityCheckbox" value="checked" %ENABLE_HUMIDITY_INPUT% onClick="this.form.submit();"></td></tr>
    <tr><td>Luftdruck</td><td><input type="checkbox" name="pressureCheckbox" value="checked" %ENABLE_PRESSURE_INPUT% onClick="this.form.submit();"></td></tr>
    <tr><td>Ort</td><td><input type="checkbox" name="locationCheckbox" value="checked" %ENABLE_LOCATION_INPUT% onClick="this.form.submit();"></td></tr>
